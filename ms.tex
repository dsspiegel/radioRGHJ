...
Observations suggest that the occurrence rate of planets with masses $M_{\rm J} < M_p \sin i < 15 M_{\rm J}$ in orbits $1 {\rm AU} < a < 5 {\rm AU}$ around F, G, or K stars is $\sim $ 3.5\% \citep{cumming2008}.  %
Therefore, given that 148 (44) systems with 1$M_{\rm J}$ planets at 1 AU (5 AU) have potential to emit $>10 \mu {\rm Jy}$, about 2-5 would actually be emitting the radio wave of our interest. %
