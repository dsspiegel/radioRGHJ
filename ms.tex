...
Although observational searches for these radio signatures are underway, no clear detection has been claimed \revise{}{\citep{bastian2000,george2007,smith2009,stroe2012,hallinan2013,murphy2015}}, though there are some promising initial results \citep{lecavelier_et_al2013,sirothia2014}.
...
P_{\rm inp,\,m} &=& \pi v B_{\star\bot }^2 \cdot \pi r_{\rm mag} ^2 \label{eq:Pinp_mag} \, ,
\end{eqnarray}
%%%
...
\revise{}{We note that their data do not unambiguously distinguish RG from early AGB stars and thus the list likely consists of about 40\% early AGB stars. }\memoYF{Doesn't ``consists of'' sound like ``A is made of B''?}
...
\revise{}{A more realistic expected number of detection can be also evaluated by combining these results with the probability for a star to have a planet with certain mass and orbit,  %
...
The analysis indicates that if the detection limit is 10$\mu {\rm Jy}$ the total expected value is about 3. }
