...
The detailed electromagnetic structure around RGHJs therefore requires  elaborate numerical simulations, which is beyond the scope of this paper. Noting that all other uncertainties, in this paper we simply aim at giving an order-of-magnitude estimate. }
...
\revise{}{We note that these data do not unambiguously distinguish RG from early AGB stars and thus the list likely includes about 40\% of early AGB stars. }
