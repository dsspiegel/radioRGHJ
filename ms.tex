...
\revise{}{We also note that the orbital velocity of the canonical hot Jupiters has been ignored in equation (\ref{eq:P_HJ}); the orbital velocity at $0.05 {\rm AU}$ around a Solar-mass star is $\sim 130 {\rm km/sec}$, which could contribute to only $\sim $5\% increase of the velocity. }
