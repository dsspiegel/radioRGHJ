...
%
David S. Spiegel\altaffilmark{2,3}
%
Tony Mroczkowski\altaffilmark{4,5}
%
Jason Nordhaus\altaffilmark{6,7}\\
%
Neil T. Zimmerman\altaffilmark{8}
%
Aaron Parsons\altaffilmark{9}
%
Nikku Madhusudhan\altaffilmark{10}
%
Mehrdad Mirbabayi\altaffilmark{2}
}
...
\affil{$^4$National Research Council Fellow}

\affil{$^5$Naval Research Laboratory, 4555 Overlook Ave SW, Washington, DC 20375}

\affil{$^6$Department of Science and Mathematics, National Technical Institute for the Deaf, Rochester Institute of Technology, Rochester, NY 14623}

\affil{$^7$Center for Computational Relativity and Gravitation, Department of Mathematics, Rochester Institute of Technology, Rochester, NY 14623}

\affil{$^8$Space Telescope Science Institute, 3700 San Martin Drive, Baltimore, MD 21218}

\affil{$^9$Astronomy Department, University of California Berkeley}

\affil{$^{10}$Astronomy Department, University of Cambridge, UK}
...
This scaling law is based on the assumption that the ohmic dissipation energy is a fraction of the available convected energy and was found to be in a good agreement with the numerical experiments over a wide parameter space and with known objects from the Earth to stars: 
