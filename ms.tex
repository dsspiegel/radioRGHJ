...
A extra fruit from observations of RGHJs in particular is that the lower cut-off frequency, which presumably corresponds to in situ plasma frequency, could probe of the stellar wind property at the planetary orbit. In addition, the planetary radio power in such an extreme environment as RG's massive stellar wind will be valuable data points to test the empirical ``radiometric Bode's law''. %
...
\end{eqnarray}
%%%
where they find $\alpha = -0.31\pm 0.2$, $\beta =0.26 \pm 0.1$, $\mathcal{C} =1.04\times 10^{-3}$  as best-fit values. %
Using this equation, the possibility of a given evolved star in Figure \ref{fig:observability} to have a RGHJ with mass larger than threshold $M_{p0}$ whose radio emission may be detectable is
%%%
\begin{equation}
...
&&\times \left( \frac{\dot M}{10^{-8} M_{\odot}/{\rm yr}} \right)^{1/2} 
\end{eqnarray}
%%%
...
&& \times \left( \frac{M_{\star }}{10^{-8}~M_{\odot }/{\rm yr}} \right)^{1/2} \left( \frac{v_{\star }}{10^{-1} v_{\odot }} \right)^{5/4} 
\end{eqnarray}
%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[htbp]
   \plotoneh{cumlative_expected_value.pdf}
   \caption{}
