...
We note that \revise{\citet{jardine2008} modeled reconnection between the magnetic fields of close-in planets and that of the star to obtain estimates that are not based on the ``radiometric Bode's law''.}
...
\revise{In addition, they considered the scenario where the post-bow shock heating could produce ionized hydrogen atoms. This indicates a configuration of radio wave generation very different from that of Solar System, and the lower-limit estimate, at least, is well below the detection limit. }
...
\revise{In addition, two major updates from \citet{ignace2010} are the following.}
\revise{First, we estimate} the plasma frequency cut-off of the stellar wind, which turns out to be one of the major obstacles to detect radio emission from RGHJs. 
\revise{Second, we discuss the planetary parameter space to  search for radio emission, employing the scaling law of planetary magnetic field, noting that the survey of exoplanets around highly evolved stars is not complete.}
