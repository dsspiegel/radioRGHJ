...
%%%%%%%%%
The solid lines show the ionization fraction of $\xi=0$ (no additional ionization by electrons) and dashed lines show that of $\xi=0.5$. In the figure, the vertical lines show the magnetic stand-off radius obtained by equation (\ref{eq:stand-off-radius_RGHJ}) below. 
