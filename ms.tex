...
While $v_{\rm sw}$ is $\sim$30~km/s, the orbital velocity is $10-30~{\rm km/s}$ depending on the orbital distance (ranging from $1-5~{\rm AU}$), and the infall velocity from the planetary gravity is $\sim 10-25~{\rm km/s}$, depending on the planetary mass (ranging from $1 M_{\rm J}-10 M_{\rm J}$). Here, we simply consider
%%%%%%%%%% 
\begin{equation}
