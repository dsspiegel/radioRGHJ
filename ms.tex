...
Finally, we note that this radio emission could studied through follow-up observations of known RGHJs or could be used as a tool for discovery, given the lowered sensitivity of radial velocity methods in detecting planetary companions. 
Once the planetary radio emission is detected, it will provide a unique approach for inferring the planetary spin, magnetic field, presence of satellites, and potentially the stellar wind properties.
