...
For example, in an idealized case with $M_p = 10 M_{\rm J}$, $k_B T_{\rm acc} \sim 172\,{\rm eV} \sim 12 \, E_{\rm Rydberg}$, a photoionization produce a photon with energy of $(12-1) = 11 E_{\rm Rydberg} $, then second ionization by that electron produce two photons with energy of $(11-1)/2 = 5 E_{\rm Rydberg}$, and the third ionization by these two photons produce four photons with energy of $(5-1)/2 = 2 E_{\rm Rydberg}$; the cascade can proceed to the forth  order at the maximum. 
