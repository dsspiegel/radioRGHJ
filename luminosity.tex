...
\begin{figure}[htbp]
   ...
   \caption{Flux distribution of sources in a spherical shell at distance $r$ with unit width $\Delta r = 1{\rm pc}$ (arbitrary) .}
  \label{fig:prob}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
%%%
\begin{equation}
n_r \equiv 4 \pi r^2 dr \int _0 ^{\infty} \frac{d^2 N}{dF~dr} dF \, . 
\end{equation}
%%%
...
The expected value of the maximum flux among the targets within a spherical shell at radius $r$ (with width $dr$), $\langle F_{\rm max} \rangle$, is obtained by calculating the flowing integral. 
%%%
\begin{eqnarray}
...
Figure \ref{fig:expectedFmax} shows $\langle F_{\rm max} \rangle$ as a function of distance $r$ with varying number density of the sources. 
