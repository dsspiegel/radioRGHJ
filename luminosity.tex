...
&=& \int _{F}^{F+dF} dF \int _0^{R} dr \; \Psi (F r^2, r)\; det(J) 
\end{eqnarray}
%%%
where
%%%
...
0 \;\;\;\; \displaystyle \left( F < \frac{L_{\rm min}}{R^2} \right) \\
\\
\displaystyle \frac{4\pi C }{5 - 2\alpha} \left[ R^{5 - 2\alpha}F^{-\alpha } -  L_{\rm min}^{2.5 - \alpha} F^{-2.5} \right] dF \\
\\
\;\;\;\;\;\;\;\;\;\;\;\;\;\;  \displaystyle \left( \frac{L_{\rm min}}{R^2} < F < \frac{L_{\rm max}}{R^2} \right) \\	
\\
\displaystyle \frac{4\pi C F^{-2.5 }}{5 - 2\alpha} \left[ L_{\rm max}^{2.5 - \alpha} - L_{\rm min}^{2.5 - \alpha}  \right] dF \\
\\
\;\;\;\;\;\;\;\;\;\;\;\;\;\; \displaystyle \left( \frac{L_{\rm max}}{R^2} < F \right) 
\end{array}
\right. 
