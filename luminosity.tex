...
\end{equation}
%%%
Here, the right thing to do would be to take an infinite sum over integer values of $n_r$ with occurrence probability function, but for the sake of simplicity, here we simply assume $n_r$ computed by equation (\ref{eq:n_r}) is a good proxy. 
