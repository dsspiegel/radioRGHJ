...
\tablehead{
Instrument & Band  & \sigRMS\tablenotemark{a} & $\tau$\tablenotemark{b}  & $\theta$\tablenotemark{c}  & $\sigma_c$\tablenotemark{d}\\
...
\tablenotetext{c}{Resolution of the instrument.}
\tablenotetext{d}{Source confusion RMS contribution.}
\end{deluxetable*}
%
% HERA
...
Source confusion is characterized by the standard deviation $\sigma_c$ in the surface brightness of an image due to one or more unresolved sources in the beam solid angle, or resolution element, $\theta$ (for a review, see \cite{Condon1974,Condon2012}).
